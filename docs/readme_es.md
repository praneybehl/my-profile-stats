<p align="center">
 ...
 <p align="center">¡Obtén tus estadísticas de GitHub generadas dinámicamente en tu README!</p>
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/praneybehl/my-profile-stats/issues/new/choose">Reporta un bug</a>
    ·
    <a href="https://github.com/praneybehl/my-profile-stats/issues/new/choose">Solicita una mejora</a>
  </p>
  <p align="center">
...
<p align="center">¿Te gusta este proyecto? ¡Por favor considera <a href="https://www.paypal.me/praneybehl">donar</a> para ayudar a mejorarlo!
...
Desde que la API de GitHub permite solo 5 mil peticiones por hora, es posible que mi `https://my-profile-stats.praneybehl.vercel.app.app/api` pueda llegar al límite. Si lo alojas en tu propio servidor de Vercel, no tendrás que preocuparte de nada. ¡Clickea en el botón "Deploy" para comenzar!

Nota: debido a esto [#58](https://github.com/praneybehl/my-profile-stats/pull/58) podríamos manejar más de 5 mil peticiones sin tener ningún problema con el downtime :D
...
- [![paypal.me/praneybehl](https://ionicabizau.github.io/badges/paypal.svg)](https://www.paypal.me/praneybehl) - Puedes hacerme una única donación a través de PayPal. Probablemente me compraré un ~~café~~ té. :tea:
